...
export default function PinAuthScreen() {
  ...
  const NumButton = ({ number, onPress }: { number: string, onPress: () => void }) => (
        ...
        <View style={styles.numpadContainer}>
          ...
          <View style={styles.row}>
            ...
            <TouchableOpacity style={styles.btnControl} onPress={handleDelete}>
              <MaterialCommunityIcons name="backspace-outline" size={28} color="white" />
            </TouchableOpacity>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  dotActive: { 
    ...
    borderColor: 'white',
    elevation: 5,
    shadowColor: 'white', shadowOpacity: 0.5, shadowRadius: 5
  },
